...
import org.bdgenomics.adam.metrics.aggregators.{ AggregatedCollection, CombinedAggregator, HistogramAggregator, Writable }
import org.bdgenomics.adam.metrics.{ BucketComparisons, Collection, CombinedComparisons, DefaultComparisons }
