...
import java.io._
import edu.berkeley.cs.amplab.adam.cli.PluginExecutor
import edu.berkeley.cs.amplab.adam.cli.PluginExecutorArgs
import org.scalatest.FunSuite

class ExternalTake10PluginSuite extends FunSuite {

  test("external take10 works correctly on example SAM") {

    val args = new PluginExecutorArgs()
    args.plugin = "edu.berkeley.cs.amplab.adam.plugins.external.ExternalTake10Plugin"
