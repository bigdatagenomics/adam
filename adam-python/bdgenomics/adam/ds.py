...
ds
===
.. currentmodule:: bdgenomics.adam.ds
.. autosummary::
   :toctree: _generate/
...
class AlignmentRecordDataset(GenomicDataset):
    ...
    def realignIndelsFromKnownIndels(self,
        ...
        :param bdgenomics.adam.ds.VariantDataset knownIndels: A genomic dataset of previously
    ...
    def reassembleReadPairs(self,
        ...
        :param pyspark.ds.RDD secondPairRdd: The ds containing the second read
        from the pairs.
...
class NucleotideContigFragmentDataset(GenomicDataset):
    ...
    def flankAdjacentFragments(self, flankLength):
        ...
        flanking sequence.
        :rtype: bdgenomics.adam.ds.NucleotideContigFragmentDataset
        """
