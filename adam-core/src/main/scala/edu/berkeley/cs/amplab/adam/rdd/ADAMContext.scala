...
import edu.berkeley.cs.amplab.adam.avro.{ADAMPileup, ADAMRecord, ADAMNucleotideContigFragment}
...
import edu.berkeley.cs.amplab.adam.projections.{ADAMRecordField, Projection,ADAMNucleotideContigFragmentField}
