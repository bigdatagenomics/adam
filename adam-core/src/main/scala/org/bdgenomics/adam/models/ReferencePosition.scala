...
import org.bdgenomics.formats.avro.{ Read, Genotype, Variant, Pileup }
...
object ReferencePositionWithOrientation {
  ...
  def apply(record: Read): Option[ReferencePositionWithOrientation] = {
  ...
  def fivePrime(record: Read): Option[ReferencePositionWithOrientation] = {
    if (record.getReadMapped) {
...
object ReferencePosition {
   ...
   */
  def mappedPositionCheck(record: Read): Boolean = {
   ...
   * @see fivePrime
   */
  def apply(record: Read): Option[ReferencePosition] = {
   ...
   */
  def fivePrime(record: Read): Option[ReferencePosition] = {
    if (mappedPositionCheck(record)) {
