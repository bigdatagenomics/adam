...
object AlignmentRecordDataset extends Serializable {
   ...
   */
  val WRITE_ORIGINAL_QUALITIES = "org.bdgenomics.adam.ds.read.AlignmentRecordDataset.writeOriginalQualities"
   ...
   */
  val WRITE_SUFFIXES = "org.bdgenomics.adam.ds.read.AlignmentRecordDataset.writeSuffixes"
...
sealed abstract class AlignmentRecordDataset extends AvroReadGroupGenomicDataset[AlignmentRecord, AlignmentRecordProduct, AlignmentRecordDataset] {
  ...
  def saveAsSam(
    ...
    conf.set("org.bdgenomics.adam.ds.read.bam_header_path", headPath.toString)
