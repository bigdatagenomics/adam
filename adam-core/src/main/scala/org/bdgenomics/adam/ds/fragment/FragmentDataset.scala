...
object FragmentDataset {
   ...
   */
  val WRITE_ORIGINAL_QUALITIES = "org.bdgenomics.adam.ds.fragment.FragmentDataset.writeOriginalQualities"
   ...
   */
  val WRITE_SUFFIXES = "org.bdgenomics.adam.ds.fragment.FragmentDataset.writeSuffixes"
