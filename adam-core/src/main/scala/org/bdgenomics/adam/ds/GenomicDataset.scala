...
private[ds] class JavaSaveArgs(var outputPath: String,
...
private[ds] object GenomicDataset {
...
trait GenomicDataset[T, U <: Product, V <: GenomicDataset[T, U, V]] extends Logging {
   ...
   */
  private[ds] def writePartitionedParquetFlag(pathName: String, partitionSize: Int): Unit = {
   ...
   *   overlapped in the genomic coordinate space.
   */
  private[ds] def shuffleRegionJoin[X, Y <: Product, Z <: GenomicDataset[X, Y, Z]](
    genomicDataset: GenomicDataset[X, Y, Z],
   ...
   *   right genomic dataset that did not overlap a key in the left genomic dataset.
   */
  private[ds] def rightOuterShuffleRegionJoin[X, Y <: Product, Z <: GenomicDataset[X, Y, Z]](
    genomicDataset: GenomicDataset[X, Y, Z],
    optPartitions: Option[Int],
    flankSize: Long)(
      implicit tTag: ClassTag[T],
   ...
   *   left genomic dataset that did not overlap a key in the right genomic dataset.
   */
  private[ds] def leftOuterShuffleRegionJoin[X, Y <: Product, Z <: GenomicDataset[X, Y, Z]](
    genomicDataset: GenomicDataset[X, Y, Z],
    optPartitions: Option[Int],
    flankSize: Long)(
      implicit tTag: ClassTag[T],
   ...
   *   left genomic dataset that did not overlap a key in the right genomic dataset.
   */
  private[ds] def leftOuterShuffleRegionJoinAndGroupByLeft[X, Y <: Product, Z <: GenomicDataset[X, Y, Z]](
    genomicDataset: GenomicDataset[X, Y, Z],
    optPartitions: Option[Int],
    flankSize: Long)(
      implicit tTag: ClassTag[T],
   ...
   *   overlap will be paired with a `None`.
   */
  private[ds] def fullOuterShuffleRegionJoin[X, Y <: Product, Z <: GenomicDataset[X, Y, Z]](
    genomicDataset: GenomicDataset[X, Y, Z],
    optPartitions: Option[Int],
    flankSize: Long)(
      implicit tTag: ClassTag[T],
   ...
   *   the value they overlapped in the left genomic dataset..
   */
  private[ds] def shuffleRegionJoinAndGroupByLeft[X, Y <: Product, Z <: GenomicDataset[X, Y, Z]](
    genomicDataset: GenomicDataset[X, Y, Z],
    optPartitions: Option[Int],
    flankSize: Long)(
      implicit tTag: ClassTag[T],
   ...
   *   right genomic dataset that did not overlap an item in the left genomic dataset.
   */
  private[ds] def rightOuterShuffleRegionJoinAndGroupByLeft[X, Y <: Product, Z <: GenomicDataset[X, Y, Z]](
    genomicDataset: GenomicDataset[X, Y, Z],
    optPartitions: Option[Int],
    flankSize: Long)(
      implicit tTag: ClassTag[T],
   ...
   */
  private[ds] def copartitionByReferenceRegion[X, Y <: Product, Z <: GenomicDataset[X, Y, Z]](
...
private[ds] case class TagHolder[T, U <: Product: TypeTag]()(
...
private[ds] trait VCFSupportingGenomicDataset[T, U <: Product, V <: VCFSupportingGenomicDataset[T, U, V]] extends GenomicDataset[T, U, V] {
...
private[ds] class InstrumentedADAMAvroParquetOutputFormat extends InstrumentedOutputFormat[Void, IndexedRecord] {
