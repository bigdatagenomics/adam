...
import edu.berkeley.cs.amplab.adam.avro.{ ADAMContig, ADAMGenotype, ADAMNucleotideContigFragment, ADAMPileup, ADAMVariant, ADAMRecord, Base }
import edu.berkeley.cs.amplab.adam.models.{ ADAMVariantContext, ReferenceRegion, SequenceDictionary, SequenceRecord }
